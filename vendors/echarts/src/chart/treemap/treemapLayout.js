define(function (require) {
    ...
    function update(ecModel, api, payload) {
        ...
        ecModel.eachComponent(condition, function (seriesModel) {
            ...
            if (payloadType !== 'treemapMove') {
                ...
                // admin_layout should be cleared because using updateView but not update.
                viewRoot.hostTree.clearLayouts();

                // TODO
                // optimize: if out of view clip, do not admin_layout.
    ...
    function initChildren(node, nodeModel, totalArea, options, hideChildren, depth) {
        ...
        for (var i = 0, len = viewChildren.length; i < len; i++) {
            ...
            // Do not use setLayout({...}, true), because it is needed to clear last admin_layout.
    ...
    // Prunning depends on admin_layout and root position, so we have to do it after admin_layout.
    function prunning(node, clipRect, viewAbovePath, viewRoot, depth) {
        ...
        node.setLayout({
            ...
            // see but still admin_layout for animation preparation but not render.
