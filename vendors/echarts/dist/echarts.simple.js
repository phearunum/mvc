...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var ComponentModel = Model.extend({
	        ...
	        /**
	         * Support merge admin_layout params.
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Layout helpers for each component positioning
	     ...
	     *     init: function () {
	     *         ...
	     *         var inputPositionParams = admin_layout.getLayoutParams(option);
	     *         this.mergeOption(inputPositionParams);
	     *     },
	     *     mergeOption: function (newOption) {
	     *         newOption && zrUtil.merge(thisOption, newOption, true);
	     *         admin_layout.mergeLayoutParam(thisOption, newOption);
	     *     }
	     * });
	     *
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var List = function (dimensions, hostModel) {
	        ...
	        /**
	         * Globel admin_layout properties.
	         * @type {Object}
	         * @private
	         */
	        this._layout = {};
	        ...
	        /**
	         * Item admin_layout properties after admin_layout
	         * @type {Array.<Object>}
	         * @private
	         */
	        this._itemLayouts = [];
	    ...
	    /**
	     * Get admin_layout of single data item
	     * @param {number} idx
	     */
	    ...
	    /**
	     * Set admin_layout of single data item
	     * @param {number} idx
	     * @param {Object} layout
	    ...
	    /**
	     * Clear all admin_layout of single data item
	     */
	    ...
	    /**
	     * Shallow clone a new list except visual and admin_layout properties, and graph elements.
	...
	// FIXME emphasis label position is not same with normal label position
	    ...
	    module.exports = function (seriesModel, r, viewWidth, viewHeight) {
	        ...
	        data.each(function (idx) {
	            ...
	            // Not admin_layout the inside label
	            if (!isLabelInside) {
