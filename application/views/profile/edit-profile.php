                ...
                <div class="wrapper">
                    <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                        ...
                        <div id="myTabContent" class="tab-content" style="border: 0px!important;">
                            ...
                            <div role="tabpanel" class="tab-pane fade fade in active" id="profile" aria-labelledby="profile-tab">
                                <div class="row">
                                            ...
                                            <div class="" style="padding: 5px">
                                                <div id="load_dealer">
                                                    <div class="row">
                                                        ...
                                                        <form method="post" class="form-horizontal" id="frm_store" enctype="multipart/form-data" >
                                                            <div class="col-sm-6" id="store_show">
                                                                ...
                                                                <p>
                                                                    ...
                                                                    <input type="text" class="form-control input-sm" name="store_name" value="Phearun Phone Shop" required>
                                                                </p>
                                                                <p>
                                                                    <label for="username">Store Number  : <span class="required">*</span></label>
                                                                    <input type="text" class="form-control input-sm" name="store_number" value="001" required>
                                                                </p>
                                                                ...
                                                                <input type="file"  name="img" id="imgInp" required />
                                                                </p>
                                                                <br/>

                                                                <p>
                                                                    <label for="username">Abount  : <span class="required">*</span></label>
                                                                    <textarea class="form-control" rows="3" name="note">             hELLO              </textarea>
